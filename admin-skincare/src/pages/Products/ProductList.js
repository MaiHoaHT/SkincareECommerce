...
const ProductList = () => {
  ...
  // Placeholder data
  const mockProducts = [
    { id: 1, name: 'Kem dưỡng da', price: '250.000', stock: 100, category: 'Skincare', brand: 'Flora' },
    { id: 2, name: 'Sữa rửa mặt', price: '150.000', stock: 200, category: 'Skincare', brand: 'Flora' },
